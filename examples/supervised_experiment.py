...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(ROOT, 'MAE_adult.png'))
print(f"Feature MAE plot saved to {os.path.join(ROOT, 'MAE_adult.png')}")
...
plt.legend()
plt.tight_layout()
plt.savefig(os.path.join(ROOT, 'MAE_adult_pred.png'))
print(f"Prediction MAE plot saved to {os.path.join(ROOT, 'MAE_adult_pred.png')}")
